...
public class MainActivity extends AppCompatActivity {
    ...
    //harga default (dollar)
    private double mPrice = 0.10;

    // Exchange rates for Indonesia(ID) and Arabic-Egypt(EG).
    double mIdExchangeRate = 14000; //indo
    double mEgExchangeRate = 18.5; //arab
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load dulu TextViewnya
        TextView expiredDateTextView = findViewById(R.id.date);
        //set untuk menyesuaikan bahasanya
        ...
        //baca settingan bahasanya apa?
        String deviceLocale = Locale.getDefault().getCountry();
        //baru hitung price nya belum ganti currency
        if(deviceLocale == "ID"){
        ...
        //selain bahasa indo dan arab, hanya menampilkan USD
        else {
        ...
        //pake default currency nya dulu
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        //baca mInputQuantity berapa
                        //cek apakah number/bukan dengan dipaksa diconvert integer
                        try {
                            mInputQuantity = mNumberFormat.parse(v.getText(). toString()).intValue();
                        } catch (ParseException e) {
                            //disuruh convert number karna selain number gabisa
